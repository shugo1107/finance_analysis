...
MIN_TRADE_SIZE_MAP = {
    PRODUCT_CODE_USD_JPY: 1000,
    PRODUCT_CODE_EUR_JPY: 1000,
    PRODUCT_CODE_EUR_USD: 1000,
    PRODUCT_CODE_GBP_JPY: 1000,
    PRODUCT_CODE_GBP_USD: 1000,
    PRODUCT_CODE_AUD_JPY: 1000,
    PRODUCT_CODE_FX_BTC_JPY: 0.01
}

MIN_TRADE_PRICE_MAP = {
    PRODUCT_CODE_USD_JPY: 0.001,
    PRODUCT_CODE_EUR_JPY: 0.001,
    PRODUCT_CODE_EUR_USD: 0.00001,
    PRODUCT_CODE_GBP_JPY: 0.001,
    PRODUCT_CODE_GBP_USD: 0.00001,
    PRODUCT_CODE_AUD_JPY: 0.001,
    PRODUCT_CODE_FX_BTC_JPY: 1
}

TRADABLE_PAIR = ["USD_JPY", "EUR_JPY", "EUR_USD", "GBP_USD", "FX_BTC_JPY"]
